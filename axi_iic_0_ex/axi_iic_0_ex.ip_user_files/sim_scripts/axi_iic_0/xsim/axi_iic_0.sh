...
#
# Generated by Vivado on Wed Aug 07 16:46:05 JST 2024
...
# Script info
echo -e "axi_iic_0.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L lib_pkg_v1_0_2 -L lib_cdc_v1_0_2 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_iic_v2_1_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_iic_0 xil_defaultlib.axi_iic_0 xil_defaultlib.glbl -log elaborate.log
}
