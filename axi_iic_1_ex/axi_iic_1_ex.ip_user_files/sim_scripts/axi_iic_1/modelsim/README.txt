...
#
# Generated by export_simulation on Wed Aug 07 16:48:46 JST 2024
#
################################################################################
...
'-reset_run' switch to the './axi_iic_1.sh' script.

./axi_iic_1.sh -reset_run
...
./axi_iic_1.sh -noclean_files

For more information on the script, please type './axi_iic_1.sh -help'.
