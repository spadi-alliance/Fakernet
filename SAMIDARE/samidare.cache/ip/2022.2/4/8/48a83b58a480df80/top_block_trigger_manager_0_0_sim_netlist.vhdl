...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_trigger_manager is
  ...
  signal trg_counter_reg : STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  signal \NLW_trg_counter_reg[0]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 5 );
  signal \NLW_trg_counter_reg[0]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 6 );
...
trg_counter0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
\trg_counter0_inferred__0/i_\: unisim.vcomponents.LUT6
    generic map(
...
\trg_counter_reg[0]_i_1\: unisim.vcomponents.CARRY8
     port map (
      CI => '0',
      CI_TOP => '0',
      CO(7 downto 5) => \NLW_trg_counter_reg[0]_i_1_CO_UNCONNECTED\(7 downto 5),
      ...
      O(7 downto 6) => \NLW_trg_counter_reg[0]_i_1_O_UNCONNECTED\(7 downto 6),
      ...
      S(7 downto 6) => B"00",
      S(5 downto 1) => trg_counter_reg(5 downto 1),
...
trg_internal_reg: unisim.vcomponents.FDSE
     port map (
      C => clk,
      CE => sel,
      D => '0',
