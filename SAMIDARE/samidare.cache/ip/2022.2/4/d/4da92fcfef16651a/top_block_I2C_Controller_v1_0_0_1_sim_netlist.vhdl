...
\i2c_wdata[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00F000F044F4FFFF"
        ...
        port map (
      I0 => \i2c_wdata_reg[2]\(1),
      I1 => p_2_in(3),
      I2 => \i2c_wdata_reg[4]\,
      I3 => \i2c_wdata[4]_i_2_n_0\,
      I4 => \i2c_wdata_reg[2]\(0),
      I5 => \i2c_wdata_reg[4]_0\,
...
\i2c_wdata[7]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"22F30000"
    )
        port map (
...
\i2c_wdata[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55555544CC001115"
    )
        port map (
      I0 => \i2c_wdata[9]_i_2_n_0\,
      I1 => \i2c_wdata_reg[2]\(1),
      I2 => \i2c_wdata_reg[9]\,
      I3 => \i2c_wdata_reg[2]\(0),
      I4 => \i2c_wdata_reg[2]\(2),
      I5 => \i2c_wdata_reg[2]\(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \state_bram[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state_bram[3]_i_4\ : label is "soft_lutpair20";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \state_i2c[1]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state_i2c[2]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state_i2c[2]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state_i2c[3]_i_3\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \state_read[1]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state_read[2]_i_1\ : label is "soft_lutpair21";
...
I2C_Controller_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI
     port map (
      ...
      \i2c_wdata_reg[0]_1\ => \i2c_waddr[3]_i_3_n_0\,
      ...
      \i2c_wdata_reg[9]\ => \i2c_waddr[3]_i_7_n_0\,
      in0 => bram_read_done,
...
i2c_rd_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000800"
    )
        port map (
...
\i2c_waddr[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFA8"
    )
        port map (
...
\i2c_waddr[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\i2c_waddr[3]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\i2c_waddr[3]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\i2c_wdata[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BF"
    )
        port map (
...
\i2c_wdata[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00E003C0"
    )
        port map (
...
\i2c_wdata[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => m00_axi_aresetn,
      I4 => \i2c_wdata[7]_i_5_n_0\,
      I5 => \i2c_wdata[8]_i_3_n_0\,
...
\i2c_wdata[7]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
i2c_wr_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\rcnt[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F2FF"
    )
        port map (
...
\state_read[1]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state_read[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => wait_cnt(16),
      I1 => wait_cnt(15),
      I2 => \state_read[1]_i_9_n_0\,
      I3 => \state_read[1]_i_10_n_0\,
...
\state_read[1]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\state_write[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F5F5F555FD5FFDFF"
    )
        port map (
      I0 => \state_read[3]_i_1_n_0\,
      I1 => \state_write[0]_i_2_n_0\,
      I2 => state_write(3),
      I3 => state_write(1),
      I4 => state_write(2),
      I5 => state_write(0),
