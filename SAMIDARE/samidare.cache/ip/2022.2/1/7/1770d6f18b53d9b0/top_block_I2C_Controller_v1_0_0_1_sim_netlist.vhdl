...
\i2c_wdata[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EA00C0FFEA00C000"
    )
        port map (
      I0 => \i2c_wdata_reg[5]\(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bram_raddr_r[7]_i_2\ : label is "soft_lutpair17";
  attribute KEEP : string;
  ...
  attribute SOFT_HLUTNM of \state_bram[2]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_bram[3]_i_2\ : label is "soft_lutpair13";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \state_w_r[0]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state_w_r[1]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state_w_r[1]_i_7\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state_w_r[2]_i_5\ : label is "soft_lutpair16";
...
i2c_rd_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FD"
    )
        port map (
...
i2c_wr_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
i2c_wr_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\rcnt[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
start_bram_read_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000200"
    )
        port map (
...
\state_w_r[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1011"
    )
        port map (
...
\state_w_r[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFB7"
    )
        port map (
...
\wcnt[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\wcnt[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\wcnt[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
