...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_switch is
  ...
  attribute FSM_ENCODED_STATES of \state_sw_reg[0]\ : label is "STATE_I2C_WRITE:0100,STATE_I2C_READ:1000,STATE_SAMPA_READ:1001,STATE_IDLE:0001,STATE_REG:0010";
  attribute FSM_ENCODED_STATES of \state_sw_reg[1]\ : label is "STATE_I2C_WRITE:0100,STATE_I2C_READ:1000,STATE_SAMPA_READ:1001,STATE_IDLE:0001,STATE_REG:0010";
begin
...
state_sw: unisim.vcomponents.LUT3
    generic map(
      INIT => X"62"
    )
        port map (
