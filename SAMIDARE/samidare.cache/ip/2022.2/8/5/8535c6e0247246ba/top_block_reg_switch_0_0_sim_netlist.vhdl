...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_switch is
  ...
  signal \state_sw[1]_i_3_n_0\ : STD_LOGIC;
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \state_sw_reg[0]\ : label is "STATE_I2C_READ:1000,STATE_SAMPA_READ:1001,STATE_REG:0010,STATE_I2C_WRITE:0100,STATE_IDLE:0001";
  attribute FSM_ENCODED_STATES of \state_sw_reg[1]\ : label is "STATE_I2C_READ:1000,STATE_SAMPA_READ:1001,STATE_REG:0010,STATE_I2C_WRITE:0100,STATE_IDLE:0001";
begin
...
\state_sw[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AB"
    )
        port map (
...
\state_sw[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"38"
    )
        port map (
...
\state_sw[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
