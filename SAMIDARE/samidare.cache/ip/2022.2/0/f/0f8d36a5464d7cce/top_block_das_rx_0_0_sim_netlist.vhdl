...
\genblk1[0].bus[0][319]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88088000"
    )
        port map (
...
\genblk1[1].bus[1][319]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88088000"
    )
        port map (
...
\genblk1[2].bus[2][319]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88088000"
    )
        port map (
...
\genblk1[3].bus[3][319]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88088000"
    )
        port map (
