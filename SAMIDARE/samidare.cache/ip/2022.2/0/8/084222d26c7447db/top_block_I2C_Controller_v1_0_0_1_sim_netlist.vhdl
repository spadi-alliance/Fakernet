...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI is
  port (
    ...
    \state_read_reg[3]\ : out STD_LOGIC_VECTOR ( 9 downto 0 );
    ...
    \i2c_wdata_reg[3]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  signal i2c_wr_i_11_n_0 : STD_LOGIC;
  ...
  signal \state_read[1]_i_11_n_0\ : STD_LOGIC;
  signal \state_read[1]_i_12_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \state_read[3]_i_2\ : label is "soft_lutpair21";
...
I2C_Controller_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI
     port map (
      ...
      \i2c_wdata_reg[3]\(3 downto 0) => state_read(3 downto 0),
      ...
      \state_read_reg[3]\(9 downto 0) => i2c_wdata(9 downto 0)
    );
...
i2c_wr_i_10: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
i2c_wr_i_11: unisim.vcomponents.LUT6
    generic map(
...
\rcnt[5]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\state_read[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\state_read[1]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state_read[1]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state_read[1]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\state_read[1]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\state_read[1]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\state_read[1]_i_8\: unisim.vcomponents.LUT6
    generic map(
