...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  signal i2c_done_r1_out : STD_LOGIC;
...
i2c_done_r_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F80"
    )
        port map (
...
i2c_done_r_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"40F04CF000000000"
    )
        port map (
      I0 => i2c_done_r_i_3_n_0,
      I1 => \^m01_axi_txn_done\,
      I2 => state_i2c(0),
      I3 => state_i2c(3),
      I4 => \^m01_axi_rready\,
      I5 => \i2c_rdata[31]_i_2_n_0\,
      O => i2c_done_r1_out
    );
i2c_done_r_i_3: unisim.vcomponents.LUT6
    generic map(
...
\i2c_rdata[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
