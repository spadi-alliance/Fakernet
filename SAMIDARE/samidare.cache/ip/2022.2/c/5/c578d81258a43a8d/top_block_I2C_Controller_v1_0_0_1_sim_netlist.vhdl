...
\i2c_wdata[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F88800FFF8880000"
    )
        port map (
      I0 => \out\(4),
      I1 => regacc_data_rd_r(5),
      I2 => \i2c_wdata_reg[5]_0\(3),
      I3 => \out\(2),
      I4 => \out\(1),
...
\bram_waddr_r[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"45"
    )
        port map (
...
i2c_rd_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AA2A222200202222"
    )
        port map (
      I0 => state_w_r(3),
      I1 => m01_axi_rvalid,
      I2 => \state_w_r[2]_i_8_n_0\,
...
\trans_cnt[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AA8A"
    )
        port map (
...
\wcnt[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
