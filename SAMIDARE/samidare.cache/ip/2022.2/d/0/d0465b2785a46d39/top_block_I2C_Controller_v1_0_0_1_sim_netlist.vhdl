...
\i2c_wdata[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF00040004000400"
        ...
        port map (
      I0 => \out\(3),
      I1 => \i2c_wdata_reg[5]\(1),
      I2 => \out\(0),
      I3 => \out\(1),
      I4 => \out\(4),
      I5 => regacc_data_rd_r(3),
      O => \i2c_wdata[3]_i_2_n_0\
    );
\i2c_wdata[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"80AAD5D5FFFFFFFF"
    )
        port map (
      I0 => \out\(2),
      I1 => \out\(1),
...
\i2c_wdata[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7F707F7F"
        ...
        port map (
      I0 => regacc_data_rd_r(5),
      I1 => \out\(4),
      I2 => \out\(1),
      I3 => \out\(2),
      I4 => \i2c_wdata_reg[5]_0\(3),
      O => \i2c_wdata[5]_i_2_n_0\
    );
\i2c_wdata[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFD850508F8FFF0F"
    )
        port map (
      I0 => \out\(4),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  signal bram_raddr_r_0 : STD_LOGIC;
  ...
  signal \state_bram[3]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bram_write_done_i_2 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of i2c_txn_done_r_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \i2c_waddr[1]_i_3\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \regacc_addr_r[0]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \regacc_addr_r[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \regacc_addr_r[2]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \regacc_addr_r[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \regacc_addr_r[4]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \regacc_addr_r[5]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \regacc_addr_r[9]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state_w_r[0]_i_10\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_w_r[0]_i_5\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state_w_r[0]_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_w_r[1]_i_5\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state_w_r[1]_i_8\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state_w_r[2]_i_7\ : label is "soft_lutpair16";
...
I2C_Controller_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI
     port map (
      ...
      \i2c_wdata_reg[5]\(3 downto 1) => rcnt(5 downto 3),
      ...
      \state_w_r_reg[4]\ => I2C_Controller_v1_0_M00_AXI_inst_n_7,
      \state_w_r_reg[4]_0\ => I2C_Controller_v1_0_M00_AXI_inst_n_30
    );
...
\bram_raddr_r[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\i2c_waddr[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"5D"
    )
        port map (
...
\rcnt[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\scnt[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5D5D5F00"
    )
        port map (
...
\scnt[1]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
\scnt[1]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000000202CE02"
    )
        port map (
      I0 => \state_i2c[3]_i_5_n_0\,
      I1 => state_i2c(0),
      I2 => rcnt(2),
      I3 => \state_i2c[3]_i_4_n_0\,
      I4 => wcnt(2),
      I5 => \scnt[1]_i_6_n_0\,
      O => \scnt[1]_i_5_n_0\
    );
\scnt[1]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\state_bram[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\state_w_r[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\state_w_r[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1011FFFF"
    )
        port map (
...
\state_w_r[0]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B0FF"
    )
        port map (
...
\state_w_r[0]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\state_w_r[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"82008A0002A80AA8"
    )
        port map (
      I0 => \state_w_r[1]_i_7_n_0\,
...
\state_w_r[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\state_w_r[1]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\state_w_r[1]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8A"
    )
        port map (
...
\state_w_r[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555455545454545"
    )
        port map (
      I0 => state_w_r(2),
      I1 => \state_w_r[0]_i_4_n_0\,
      I2 => m01_axi_rvalid,
      I3 => \state_w_r[2]_i_6_n_0\,
...
\state_w_r[2]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FDDF"
    )
        port map (
...
\state_w_r[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000060FF7070"
    )
        port map (
      I0 => state_w_r(2),
      I1 => state_w_r(0),
      I2 => state_w_r(3),
      I3 => \state_w_r[3]_i_2_n_0\,
      I4 => state_w_r(1),
      I5 => state_w_r(4),
      O => \p_0_in__1\(3)
    );
...
\state_w_r[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\wait_cnt[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8088FFFF80008000"
    )
        port map (
      I0 => state_w_r(1),
      I1 => m00_axi_aresetn,
      I2 => wait_cnt0(10),
      I3 => \wait_cnt[16]_i_5_n_0\,
...
\wait_cnt[16]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2A2A2AAA"
    )
        port map (
...
\wait_cnt[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"80D0808000000000"
    )
        port map (
      I0 => state_w_r(1),
      I1 => \wait_cnt[16]_i_5_n_0\,
      I2 => m00_axi_aresetn,
      I3 => i2c_txn_done_r,
      I4 => \^m01_axi_txn_done\,
...
\wcnt[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state_w_r(3),
      I4 => state_w_r(0),
      I5 => \state_bram[3]_i_4_n_0\,
      O => \wcnt[1]_i_2_n_0\
    );
\wcnt[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"333F777F44440000"
    )
        port map (
      I0 => \wcnt[7]_i_3_n_0\,
      I1 => m00_axi_aresetn,
