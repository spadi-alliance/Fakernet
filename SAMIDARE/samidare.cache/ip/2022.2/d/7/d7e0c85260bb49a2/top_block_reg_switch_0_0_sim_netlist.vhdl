...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_switch is
  ...
  signal \state_sw__0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \state_sw[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state_sw[1]_i_2\ : label is "soft_lutpair0";
begin
...
\state_sw[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0A80"
    )
        port map (
...
\state_sw_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
