...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI is
  port (
    ...
    \state_w_r_reg[4]\ : out STD_LOGIC;
    \state_w_r_reg[4]_0\ : out STD_LOGIC;
    \regacc_data_rd_r_reg[6]_0\ : out STD_LOGIC;
...
\i2c_wdata[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"C8FFB830C8C0FFFF"
    )
        port map (
      I0 => regacc_data_rd_r(6),
      I1 => \out\(1),
      I2 => \i2c_wdata_reg[7]\(0),
      I3 => \out\(4),
      I4 => \out\(2),
      I5 => \out\(0),
      O => \regacc_data_rd_r_reg[6]_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  signal bram_waddr_r_0 : STD_LOGIC;
  ...
  signal bram_wdata_r_2 : STD_LOGIC;
  ...
  signal \rcnt[5]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \state_w_r[3]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \trans_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \trans_cnt[1]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \trans_cnt[3]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bram_write_done_i_2 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of i2c_txn_done_r_i_1 : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \regacc_addr_r[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \regacc_addr_r[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \regacc_addr_r[2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \regacc_addr_r[3]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \regacc_addr_r[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \regacc_addr_r[5]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \regacc_addr_r[6]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \regacc_addr_r[7]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \regacc_addr_r[9]_i_2\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \state_i2c[2]_i_2\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \state_w_r[1]_i_7\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_w_r[2]_i_5\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state_w_r[4]_i_2\ : label is "soft_lutpair21";
...
I2C_Controller_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI
     port map (
      ...
      \i2c_wdata_reg[5]\(3 downto 1) => wcnt(5 downto 3),
      \i2c_wdata_reg[5]\(0) => wcnt(0),
      \i2c_wdata_reg[5]_0\(3 downto 1) => rcnt(5 downto 3),
      ...
      \regacc_data_rd_r_reg[6]_0\ => I2C_Controller_v1_0_M00_AXI_inst_n_7,
      ...
      \state_w_r_reg[4]\ => I2C_Controller_v1_0_M00_AXI_inst_n_5,
      \state_w_r_reg[4]_0\ => I2C_Controller_v1_0_M00_AXI_inst_n_6
    );
...
\i2c_waddr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00D0"
    )
        port map (
...
\i2c_wdata[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000EFEE"
    )
        port map (
...
\rcnt[5]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\rcnt[5]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\scnt[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
start_bram_read_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0008"
    )
        port map (
...
\state_bram[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\state_i2c[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAA88008A00"
    )
        port map (
      I0 => state_i2c(2),
      I1 => \state_i2c[3]_i_4_n_0\,
      I2 => \state_i2c[3]_i_3_n_0\,
      I3 => state_i2c(3),
      I4 => state_i2c(0),
      I5 => \state_i2c[2]_i_2_n_0\,
      O => \p_0_in__2\(2)
    );
\state_i2c[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\state_i2c[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0008"
    )
        port map (
...
\state_w_r[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => i2c_txn_done_r,
      I4 => state_w_r(0),
      I5 => start_bram_write_i_3_n_0,
      O => \state_w_r[0]_i_3_n_0\
    );
\state_w_r[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11111011"
    )
        port map (
...
\state_w_r[0]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"C04C004C0CC000CC"
    )
        port map (
      I0 => start_bram_read_i_3_n_0,
      I1 => \state_w_r[1]_i_8_n_0\,
      I2 => \state_w_r[1]_i_7_n_0\,
      I3 => state_w_r(0),
      I4 => \state_w_r[4]_i_2_n_0\,
      I5 => state_w_r(1),
...
\state_w_r[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state_w_r(2),
      I4 => \state_w_r[1]_i_5_n_0\,
      I5 => \state_w_r[1]_i_6_n_0\,
      O => \p_0_in__1\(1)
    );
\state_w_r[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAEBBBEBAB"
    )
        port map (
      I0 => state_w_r(4),
      I1 => state_w_r(1),
      I2 => state_w_r(0),
      I3 => \wait_cnt[16]_i_3_n_0\,
      I4 => state_w_r(2),
      I5 => state_w_r(3),
      O => \state_w_r[1]_i_2_n_0\
    );
\state_w_r[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFBFF"
    )
        port map (
...
\state_w_r[1]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0700FC00C7000000"
    )
        port map (
      I0 => start_bram_read_i_3_n_0,
      I1 => \state_w_r[1]_i_7_n_0\,
      I2 => state_w_r(0),
      I3 => \state_w_r[1]_i_8_n_0\,
      I4 => state_w_r(1),
      I5 => \state_w_r[4]_i_2_n_0\,
...
\state_w_r[1]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\state_w_r[2]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\state_w_r[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"22DD00FF000F00FF"
    )
        port map (
      I0 => \state_w_r[4]_i_2_n_0\,
      I1 => trans_cnt(0),
      I2 => \state_w_r[2]_i_6_n_0\,
      I3 => state_w_r(2),
      I4 => state_w_r(1),
      I5 => state_w_r(0),
...
\state_w_r[2]_i_5\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => state_w_r(4),
      I3 => state_w_r(3),
      I4 => \state_w_r[2]_i_9_n_0\,
      O => \state_w_r[2]_i_5_n_0\
    );
\state_w_r[2]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
...
\state_w_r[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF0000088"
    )
        port map (
      I0 => \trans_cnt[3]_i_3_n_0\,
      I1 => state_i2c(0),
      I2 => \wait_cnt[16]_i_3_n_0\,
      I3 => state_w_r(2),
      I4 => state_w_r(0),
...
\state_w_r[4]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\trans_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7555777730003000"
    )
        port map (
      I0 => m00_axi_aresetn,
      I1 => \trans_cnt[1]_i_2_n_0\,
      I2 => trans_cnt(2),
      I3 => trans_cnt(0),
      I4 => \trans_cnt[2]_i_3_n_0\,
      I5 => trans_cnt(1),
      O => \trans_cnt[1]_i_1_n_0\
    );
...
\trans_cnt[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\trans_cnt[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \state_w_r[4]_i_2_n_0\,
      I2 => trans_cnt(0),
      I3 => \trans_cnt[3]_i_2_n_0\,
      I4 => m00_axi_aresetn,
      I5 => \trans_cnt[3]_i_3_n_0\,
      O => \trans_cnt[3]_i_1_n_0\
    );
...
\trans_cnt[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\wait_cnt[16]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\wait_cnt[16]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2A2A2AAA"
    )
        port map (
...
\wcnt[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
\wcnt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"47FF8800"
    )
        port map (
...
\wcnt[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7CCC4444"
    )
        port map (
...
\wcnt[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
