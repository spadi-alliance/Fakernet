...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI is
  port (
    ...
    \i2c_wdata_reg[2]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of axi_arvalid_i_1 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \read_index[0]_i_1\ : label is "soft_lutpair18";
...
bram_read_done_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B0FF0000B0FFB0FF"
    )
        port map (
      I0 => \state_bram_reg[2]_1\,
...
\i2c_wdata[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A3A2AEB2A3A2A2B2"
    )
        port map (
      I0 => \i2c_wdata[2]_i_2_n_0\,
      I1 => \i2c_wdata_reg[2]\(2),
      I2 => \i2c_wdata_reg[2]\(3),
      I3 => \i2c_wdata_reg[2]\(0),
      I4 => \i2c_wdata_reg[2]\(1),
      I5 => p_2_in(1),
      O => D(2)
    );
\i2c_wdata[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000075997511"
    )
        port map (
      I0 => \out\(2),
      I1 => \out\(1),
...
\i2c_wdata[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00EF00CF00EF0000"
    )
        port map (
      I0 => p_2_in(2),
      I1 => \i2c_wdata_reg[2]\(3),
      I2 => \i2c_wdata_reg[2]\(2),
...
\i2c_wdata[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4444F4444444FFFF"
    )
        port map (
      I0 => \i2c_wdata[4]_i_2_n_0\,
      I1 => \i2c_wdata_reg[4]\,
      I2 => \i2c_wdata_reg[1]_2\,
      I3 => p_2_in(3),
      I4 => \i2c_wdata_reg[1]_1\,
      I5 => \i2c_wdata_reg[2]\(0),
      O => D(4)
    );
...
\i2c_wdata[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5F5F1F111F1B1F11"
    )
        port map (
      I0 => \i2c_wdata_reg[1]_1\,
      I1 => \i2c_wdata_reg[2]\(0),
...
\i2c_wdata[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F8EDFBED08000800"
    )
        port map (
      I0 => \i2c_wdata_reg[2]\(2),
      I1 => \i2c_wdata_reg[2]\(0),
      I2 => \i2c_wdata_reg[2]\(3),
      I3 => \i2c_wdata_reg[2]\(1),
      I4 => \i2c_wdata_reg[1]\,
      I5 => \i2c_wdata[9]_i_2_n_0\,
      O => D(9)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0 is
  ...
  signal I2C_Controller_v1_0_M00_AXI_inst_n_3 : STD_LOGIC;
  signal I2C_Controller_v1_0_M00_AXI_inst_n_38 : STD_LOGIC;
  signal I2C_Controller_v1_0_M00_AXI_inst_n_4 : STD_LOGIC;
  ...
  signal \i2c_wdata[31]_i_4_n_0\ : STD_LOGIC;
  signal \i2c_wdata[31]_i_5_n_0\ : STD_LOGIC;
  signal \i2c_wdata[31]_i_6_n_0\ : STD_LOGIC;
  signal \i2c_wdata[31]_i_7_n_0\ : STD_LOGIC;
  ...
  signal i2c_wr_i_10_n_0 : STD_LOGIC;
  ...
  signal \state_i2c[2]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \state_read[1]_i_10_n_0\ : STD_LOGIC;
  ...
  signal \state_read[1]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \state_i2c[1]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state_i2c[2]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state_i2c[2]_i_4\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state_i2c[3]_i_3\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \state_read[0]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state_read[1]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state_read[1]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state_read[2]_i_1\ : label is "soft_lutpair20";
...
I2C_Controller_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_Controller_v1_0_M00_AXI
     port map (
      ...
      \i2c_wdata_reg[1]\ => \i2c_waddr[3]_i_5_n_0\,
      \i2c_wdata_reg[1]_0\ => \i2c_wdata[1]_i_2_n_0\,
      \i2c_wdata_reg[1]_1\ => \i2c_wdata[7]_i_2_n_0\,
      \i2c_wdata_reg[1]_2\ => \i2c_wdata[7]_i_5_n_0\,
      \i2c_wdata_reg[2]\(3 downto 0) => state_read(3 downto 0),
      \i2c_wdata_reg[2]_0\ => \i2c_wdata[2]_i_3_n_0\,
      \i2c_wdata_reg[4]\ => \i2c_wdata[8]_i_2_n_0\,
      \i2c_wdata_reg[5]\(4 downto 0) => wcnt(5 downto 1),
      \i2c_wdata_reg[6]\ => \i2c_wdata[7]_i_4_n_0\,
      ...
      p_2_in(6 downto 5) => scnt(1 downto 0),
      p_2_in(4 downto 0) => rcnt(5 downto 1),
...
\i2c_waddr[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"CD"
    )
        port map (
...
\i2c_wdata[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\i2c_wdata[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BF"
    )
        port map (
...
\i2c_wdata[31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FD00"
    )
        port map (
      I0 => \i2c_wdata[31]_i_3_n_0\,
      I1 => \i2c_wdata[31]_i_4_n_0\,
      I2 => \i2c_wdata[0]_i_2_n_0\,
      I3 => m00_axi_aresetn,
      I4 => \i2c_wdata[31]_i_5_n_0\,
      O => \i2c_wdata[31]_i_1_n_0\
    );
\i2c_wdata[31]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0500FFFF03FF"
    )
        port map (
      I0 => \i2c_wdata[31]_i_6_n_0\,
...
\i2c_wdata[31]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF0010"
    )
        port map (
      ...
      I2 => state_write(3),
      I3 => state_write(1),
      I4 => \i2c_wdata[31]_i_7_n_0\,
      O => \i2c_wdata[31]_i_4_n_0\
    );
\i2c_wdata[31]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"CCCCCFD3"
    )
        port map (
      ...
      I3 => state_read(0),
      I4 => state_read(2),
      O => \i2c_wdata[31]_i_5_n_0\
    );
\i2c_wdata[31]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
      ...
      I2 => state_bram(3),
      I3 => state_bram(2),
      O => \i2c_wdata[31]_i_6_n_0\
    );
\i2c_wdata[31]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\i2c_wdata[7]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BBA9"
    )
        port map (
...
i2c_wr_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"11FC"
    )
        port map (
...
i2c_wr_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state_write(2),
      I4 => state_write(3),
      I5 => \i2c_wdata[31]_i_6_n_0\,
      O => i2c_wr_i_3_n_0
    );
i2c_wr_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000000000EA02"
    )
        port map (
      I0 => i2c_wr_i_9_n_0,
      I1 => state_write(0),
...
i2c_wr_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
i2c_wr_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA8AAA"
    )
        port map (
...
\rcnt[7]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\state_bram[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF777F7"
    )
        port map (
...
\state_bram[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\state_bram[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F7FF"
    )
        port map (
...
\state_i2c[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
...
\state_i2c[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\state_i2c[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\state_i2c[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\state_i2c[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\state_i2c[3]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\state_i2c[3]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\state_read[1]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\state_read[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFDD"
    )
        port map (
...
\state_read[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4FFF"
    )
        port map (
      I0 => \state_read[1]_i_9_n_0\,
      I1 => \state_read[1]_i_10_n_0\,
      I2 => wait_cnt(16),
      I3 => wait_cnt(15),
...
\state_read[1]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\state_read[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
\state_write[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFCFFFCCFDCFFDCF"
    )
        port map (
      I0 => state_write(2),
      I1 => \state_write[3]_i_2_n_0\,
      I2 => state_write(0),
      I3 => state_write(3),
...
\state_write[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8881"
    )
        port map (
...
\wcnt[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
