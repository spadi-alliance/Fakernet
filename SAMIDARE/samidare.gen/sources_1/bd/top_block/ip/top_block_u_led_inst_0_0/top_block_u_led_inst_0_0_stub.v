...
module top_block_u_led_inst_0_0(clk125MHz, reset, enable, fnet_txn, power_on, 
  LED_REG0, LED_REG1, LED_REG2, LED_REG3, DIPSW, INIT_AXI_TXN, INIT_AXI_TXN_SUB, LED_TXN_DONE, LED)
/* synthesis syn_black_box black_box_pad_pin="clk125MHz,reset,enable,fnet_txn,power_on,LED_REG0[31:0],LED_REG1[31:0],LED_REG2[31:0],LED_REG3[31:0],DIPSW[3:0],INIT_AXI_TXN,INIT_AXI_TXN_SUB,LED_TXN_DONE,LED[3:0]" */;
  input clk125MHz;
  input reset;
  input enable;
  input fnet_txn;
