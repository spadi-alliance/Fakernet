...
entity top_block_trigger_manager_0_0_trigger_manager is
  port (
    trg : out STD_LOGIC;
    en : out STD_LOGIC;
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of top_block_trigger_manager_0_0_trigger_manager : entity is "trigger_manager";
end top_block_trigger_manager_0_0_trigger_manager;

architecture STRUCTURE of top_block_trigger_manager_0_0_trigger_manager is
  ...
  signal \trg_counter[16]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \trg_internal[0]_i_1_n_0\ : STD_LOGIC;
  signal \trg_internal_reg_n_0_[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \trg_internal[0]_i_1\ : label is "soft_lutpair0";
begin
  trg <= \^trg\;
...
trg_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0EEE"
        ...
        port map (
      I0 => external_trg,
      I1 => \trg_internal_reg_n_0_[0]\,
      I2 => \^trg\,
      I3 => busy_i,
      O => trg_i_1_n_0
    );
\trg_internal[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
    )
        port map (
      I0 => \trg_internal_reg_n_0_[0]\,
      I1 => \trg_counter[16]_i_2_n_0\,
      I2 => \trg_counter[16]_i_5_n_0\,
      O => \trg_internal[0]_i_1_n_0\
    );
\trg_internal_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \trg_internal[0]_i_1_n_0\,
      Q => \trg_internal_reg_n_0_[0]\,
      R => '0'
    );
...
entity top_block_trigger_manager_0_0 is
  ...
  attribute NotValidForBitStream of top_block_trigger_manager_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_block_trigger_manager_0_0 : entity is "top_block_trigger_manager_0_0,trigger_manager,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_block_trigger_manager_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of top_block_trigger_manager_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_block_trigger_manager_0_0 : entity is "trigger_manager,Vivado 2022.2";
...
inst: entity work.top_block_trigger_manager_0_0_trigger_manager
     port map (
