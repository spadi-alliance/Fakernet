...
architecture STRUCTURE of top_block_reg_switch_0_0_reg_switch is
  ...
  signal trg_en_r_i_4_n_0 : STD_LOGIC;
  signal trg_en_r_i_5_n_0 : STD_LOGIC;
  signal trg_en_r_i_6_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \state_sw[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state_sw[1]_i_3\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \state_sw_reg[0]\ : label is "STATE_IDLE:0001,STATE_REG:0010,";
  attribute FSM_ENCODED_STATES of \state_sw_reg[1]\ : label is "STATE_IDLE:0001,STATE_REG:0010,";
begin
...
\state_sw[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEEF0FF"
    )
        port map (
...
\state_sw[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
trg_en_r_i_2: unisim.vcomponents.LUT6
    generic map(
...
trg_en_r_i_3: unisim.vcomponents.LUT6
    generic map(
...
trg_en_r_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000100000000"
    )
        port map (
...
trg_en_r_i_5: unisim.vcomponents.LUT6
    generic map(
...
trg_en_r_i_6: unisim.vcomponents.LUT6
    generic map(
