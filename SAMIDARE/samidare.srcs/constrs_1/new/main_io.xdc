...
create_clock -name BASECLK -period 25.0 [get_ports BASECLK]
...
set_property IOSTANDARD HSTL_I_18 [get_ports HBTRG_N]
set_property IOSTANDARD HSTL_I_18 [get_ports HBTRG_P]
set_property IOSTANDARD HSTL_I_18 [get_ports BX_SYNC_TRG_N]
set_property IOSTANDARD HSTL_I_18 [get_ports BX_SYNC_TRG_P]
set_property IOSTANDARD HSTL_I_18 [get_ports {TRG_N[*]}]
set_property IOSTANDARD HSTL_I_18 [get_ports {TRG_P[*]}]
set_property IOSTANDARD HSTL_I_18 [get_ports {HRSTB_N[*]}]
set_property IOSTANDARD HSTL_I_18 [get_ports {HRSTB_P[*]}]
set_property IOSTANDARD HSTL_I_18 [get_ports {CLKSOIN_N[*]}]
set_property IOSTANDARD HSTL_I_18 [get_ports {CLKSOIN_P[*]}]
#______________________________________________
# GPIO
...
set_property IOSTANDARD LVCMOS12 [get_ports SAMPA_I2C_*]
#______________________________________________
# SAMPA CONFIG
