...
#
# Generated by Vivado on Wed Jan 24 21:15:59 JST 2024
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../E07-3DMatrix.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_clk_wiz.v" \
    "$ref_dir/../../../../E07-3DMatrix.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ytlai/svn/fakernet/fakernet-0.9.5/boards/HUL/E07-3DMatrix.cache/compile_simlib/vcs"
  fi
