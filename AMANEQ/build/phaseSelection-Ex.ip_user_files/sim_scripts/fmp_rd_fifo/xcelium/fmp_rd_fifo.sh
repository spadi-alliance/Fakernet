...
#
# Script generated by Vivado on Fri Mar 29 17:17:54 JST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : fmp_rd_fifo.sh
...
#
# Usage        : fmp_rd_fifo.sh
#                fmp_rd_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fmp_rd_fifo.sh [-reset_run]
#                fmp_rd_fifo.sh [-reset_log]
#                fmp_rd_fifo.sh [-help]
#
...
#                script (type 'fmp_rd_fifo.sh -help' for more information).
#
...
# script info
echo -e "fmp_rd_fifo.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fmp_rd_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.fmp_rd_fifo mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.fmp_rd_fifo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fmp_rd_fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fmp_rd_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fmp_rd_fifo.sh [-help]\n\
Usage: fmp_rd_fifo.sh [-step]\n\
Usage: fmp_rd_fifo.sh [-lib_map_path]\n\
Usage: fmp_rd_fifo.sh [-reset_run]\n\
Usage: fmp_rd_fifo.sh [-reset_log]\n\
Usage: fmp_rd_fifo.sh [-keep_index]\n\
Usage: fmp_rd_fifo.sh [-noclean_files]\n\n\
