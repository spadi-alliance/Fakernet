...
#
# Script generated by Vivado on Fri Mar 29 17:18:01 JST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : sem_controller.sh
...
#
# Usage        : sem_controller.sh
#                sem_controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sem_controller.sh [-reset_run]
#                sem_controller.sh [-reset_log]
#                sem_controller.sh [-help]
#
...
#                script (type 'sem_controller.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname sem_v4_1_13 -libname mylib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm sem_v4_1_13 mylib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sem_controller.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sem_controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work sem_v4_1_13 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.sem_controller mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.sem_controller -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sem_controller_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sem_controller.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sem_controller.sh [-help]\n\
Usage: sem_controller.sh [-step]\n\
Usage: sem_controller.sh [-lib_map_path]\n\
Usage: sem_controller.sh [-reset_run]\n\
Usage: sem_controller.sh [-reset_log]\n\
Usage: sem_controller.sh [-keep_index]\n\
Usage: sem_controller.sh [-noclean_files]\n\n\
