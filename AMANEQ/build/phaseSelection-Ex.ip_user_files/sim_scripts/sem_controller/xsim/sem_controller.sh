...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L sem_v4_1_13 -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sem_controller mylib.sem_controller mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sem_controller -key {Behavioral:sim_1:Functional:sem_controller} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sem_controller.wdb xsim.dir libdpi.so)
