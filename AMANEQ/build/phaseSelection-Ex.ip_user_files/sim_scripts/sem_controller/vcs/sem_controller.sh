...
design_libs=(xpm sem_v4_1_13 mylib)
...
compile()
{
  ...
  vlogan -work sem_v4_1_13 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts mylib.sem_controller mylib.glbl -o sem_controller_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sem_controller_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sem_controller_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sem_controller_simv.daidir vcs_lib c.obj)
