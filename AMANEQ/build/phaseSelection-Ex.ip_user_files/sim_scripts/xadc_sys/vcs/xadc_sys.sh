...
elaborate()
{
  vcs $vcs_elab_opts mylib.xadc_sys mylib.glbl -o xadc_sys_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xadc_sys_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key xadc_sys_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xadc_sys_simv.daidir vcs_lib c.obj)
