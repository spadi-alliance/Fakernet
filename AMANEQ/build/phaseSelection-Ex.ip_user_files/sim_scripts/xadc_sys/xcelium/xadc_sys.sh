...
#
# Script generated by Vivado on Fri Mar 29 17:18:07 JST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : xadc_sys.sh
...
#
# Usage        : xadc_sys.sh
#                xadc_sys.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_sys.sh [-reset_run]
#                xadc_sys.sh [-reset_log]
#                xadc_sys.sh [-help]
#
...
#                script (type 'xadc_sys.sh -help' for more information).
#
...
# script info
echo -e "xadc_sys.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_sys.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work mylib -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.xadc_sys mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.xadc_sys -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xadc_sys_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xadc_sys.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xadc_sys.sh [-help]\n\
Usage: xadc_sys.sh [-step]\n\
Usage: xadc_sys.sh [-lib_map_path]\n\
Usage: xadc_sys.sh [-reset_run]\n\
Usage: xadc_sys.sh [-reset_log]\n\
Usage: xadc_sys.sh [-keep_index]\n\
Usage: xadc_sys.sh [-noclean_files]\n\n\
