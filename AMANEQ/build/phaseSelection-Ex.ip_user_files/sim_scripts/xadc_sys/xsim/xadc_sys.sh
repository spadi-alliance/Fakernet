...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_sys mylib.xadc_sys mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_sys -key {Behavioral:sim_1:Functional:xadc_sys} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_sys.wdb xsim.dir libdpi.so)
