...
elaborate()
{
  vcs $vcs_elab_opts mylib.RbcpCdc_SysToLink mylib.glbl -o RbcpCdc_SysToLink_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RbcpCdc_SysToLink_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key RbcpCdc_SysToLink_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RbcpCdc_SysToLink_simv.daidir vcs_lib c.obj)
