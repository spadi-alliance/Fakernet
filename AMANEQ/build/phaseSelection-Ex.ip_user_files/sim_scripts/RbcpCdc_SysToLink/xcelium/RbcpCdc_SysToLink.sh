...
#
# Script generated by Vivado on Fri Mar 29 17:17:13 JST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : RbcpCdc_SysToLink.sh
...
#
# Usage        : RbcpCdc_SysToLink.sh
#                RbcpCdc_SysToLink.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RbcpCdc_SysToLink.sh [-reset_run]
#                RbcpCdc_SysToLink.sh [-reset_log]
#                RbcpCdc_SysToLink.sh [-help]
#
...
#                script (type 'RbcpCdc_SysToLink.sh -help' for more information).
#
...
# script info
echo -e "RbcpCdc_SysToLink.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RbcpCdc_SysToLink.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.RbcpCdc_SysToLink mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.RbcpCdc_SysToLink -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log RbcpCdc_SysToLink_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RbcpCdc_SysToLink.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RbcpCdc_SysToLink.sh [-help]\n\
Usage: RbcpCdc_SysToLink.sh [-step]\n\
Usage: RbcpCdc_SysToLink.sh [-lib_map_path]\n\
Usage: RbcpCdc_SysToLink.sh [-reset_run]\n\
Usage: RbcpCdc_SysToLink.sh [-reset_log]\n\
Usage: RbcpCdc_SysToLink.sh [-keep_index]\n\
Usage: RbcpCdc_SysToLink.sh [-noclean_files]\n\n\
