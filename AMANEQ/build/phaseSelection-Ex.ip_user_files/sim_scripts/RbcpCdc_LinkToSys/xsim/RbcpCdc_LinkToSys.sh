...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_8 -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RbcpCdc_LinkToSys mylib.RbcpCdc_LinkToSys mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RbcpCdc_LinkToSys -key {Behavioral:sim_1:Functional:RbcpCdc_LinkToSys} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RbcpCdc_LinkToSys.wdb xsim.dir libdpi.so)
