...
#
# Script generated by Vivado on Fri Mar 29 17:17:30 JST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : RbcpCdc_LinkToSys.sh
...
#
# Usage        : RbcpCdc_LinkToSys.sh
#                RbcpCdc_LinkToSys.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RbcpCdc_LinkToSys.sh [-reset_run]
#                RbcpCdc_LinkToSys.sh [-reset_log]
#                RbcpCdc_LinkToSys.sh [-help]
#
...
#                script (type 'RbcpCdc_LinkToSys.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_8 -libname mylib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_8 mylib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "RbcpCdc_LinkToSys.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RbcpCdc_LinkToSys.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.RbcpCdc_LinkToSys mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.RbcpCdc_LinkToSys -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/c/Documents/github/saz12341/phaseSelection-Ex/build/phaseSelection-Ex.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log RbcpCdc_LinkToSys_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RbcpCdc_LinkToSys.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RbcpCdc_LinkToSys.sh [-help]\n\
Usage: RbcpCdc_LinkToSys.sh [-step]\n\
Usage: RbcpCdc_LinkToSys.sh [-lib_map_path]\n\
Usage: RbcpCdc_LinkToSys.sh [-reset_run]\n\
Usage: RbcpCdc_LinkToSys.sh [-reset_log]\n\
Usage: RbcpCdc_LinkToSys.sh [-keep_index]\n\
Usage: RbcpCdc_LinkToSys.sh [-noclean_files]\n\n\
