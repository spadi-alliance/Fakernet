...
design_libs=(xpm fifo_generator_v13_2_8 mylib)
...
compile()
{
  ...
  vlogan -work mylib $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts mylib.RbcpCdc_LinkToSys mylib.glbl -o RbcpCdc_LinkToSys_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./RbcpCdc_LinkToSys_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/c/Documents/github/saz12341/phaseSelection-Ex/build/phaseSelection-Ex.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key RbcpCdc_LinkToSys_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc RbcpCdc_LinkToSys_simv.daidir vcs_lib c.obj)
