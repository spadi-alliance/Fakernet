...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L gig_ethernet_pcs_pma_v16_2_12 -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma mylib.gig_ethernet_pcs_pma mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gig_ethernet_pcs_pma -key {Behavioral:sim_1:Functional:gig_ethernet_pcs_pma} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gig_ethernet_pcs_pma.wdb xsim.dir libdpi.so)
