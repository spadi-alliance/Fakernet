...
design_libs=(xpm gig_ethernet_pcs_pma_v16_2_12 mylib)
...
elaborate()
{
  vcs $vcs_elab_opts mylib.gig_ethernet_pcs_pma mylib.glbl -o gig_ethernet_pcs_pma_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gig_ethernet_pcs_pma_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gig_ethernet_pcs_pma_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gig_ethernet_pcs_pma_simv.daidir vcs_lib c.obj)
