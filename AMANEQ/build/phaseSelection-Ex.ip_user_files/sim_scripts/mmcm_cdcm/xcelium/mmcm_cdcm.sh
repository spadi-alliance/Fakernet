...
#
# Script generated by Vivado on Fri Mar 29 16:45:13 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mmcm_cdcm.sh
...
#
# Usage        : mmcm_cdcm.sh
#                mmcm_cdcm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mmcm_cdcm.sh [-reset_run]
#                mmcm_cdcm.sh [-reset_log]
#                mmcm_cdcm.sh [-help]
#
...
#                script (type 'mmcm_cdcm.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname mylib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm mylib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mmcm_cdcm.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mmcm_cdcm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" \
  ...
  xmvlog -work mylib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.mmcm_cdcm mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.mmcm_cdcm -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mmcm_cdcm_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mmcm_cdcm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mmcm_cdcm.sh [-help]\n\
Usage: mmcm_cdcm.sh [-step]\n\
Usage: mmcm_cdcm.sh [-lib_map_path]\n\
Usage: mmcm_cdcm.sh [-reset_run]\n\
Usage: mmcm_cdcm.sh [-reset_log]\n\
Usage: mmcm_cdcm.sh [-keep_index]\n\
Usage: mmcm_cdcm.sh [-noclean_files]\n\n\
