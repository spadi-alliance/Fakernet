...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" \
  ...
  vlogan -work mylib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" \
...
elaborate()
{
  vcs $vcs_elab_opts mylib.mmcm_cdcm mylib.glbl -o mmcm_cdcm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mmcm_cdcm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mmcm_cdcm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mmcm_cdcm_simv.daidir vcs_lib c.obj)
