...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mmcm_cdcm mylib.mmcm_cdcm mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mmcm_cdcm -key {Behavioral:sim_1:Functional:mmcm_cdcm} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mmcm_cdcm.wdb xsim.dir libdpi.so)
