...
vlog -work xpm  -incr "+incdir+../../../ipstatic" "+incdir+../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" -l xpm -l mylib \
...
vlog -work mylib  -incr -v2k5 "+incdir+../../../ipstatic" "+incdir+../../../../../../../LaccpSecondary-Ex.gen/sources_1/ip/mmcm_cdcm" -l xpm -l mylib \
