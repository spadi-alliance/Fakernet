...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_8 -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fmp_wd_fifo mylib.fmp_wd_fifo mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fmp_wd_fifo -key {Behavioral:sim_1:Functional:fmp_wd_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fmp_wd_fifo.wdb xsim.dir libdpi.so)
