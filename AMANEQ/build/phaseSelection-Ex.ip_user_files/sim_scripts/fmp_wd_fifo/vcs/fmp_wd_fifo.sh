...
elaborate()
{
  vcs $vcs_elab_opts mylib.fmp_wd_fifo mylib.glbl -o fmp_wd_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fmp_wd_fifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fmp_wd_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fmp_wd_fifo_simv.daidir vcs_lib c.obj)
