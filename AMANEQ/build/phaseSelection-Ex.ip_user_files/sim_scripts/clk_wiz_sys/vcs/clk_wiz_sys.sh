...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../amaneq-skeleton.gen/sources_1/ip/clk_wiz_sys" \
  ...
  vlogan -work mylib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../amaneq-skeleton.gen/sources_1/ip/clk_wiz_sys" \
...
elaborate()
{
  vcs $vcs_elab_opts mylib.clk_wiz_sys mylib.glbl -o clk_wiz_sys_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_wiz_sys_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_wiz_sys_simv.daidir vcs_lib c.obj)
