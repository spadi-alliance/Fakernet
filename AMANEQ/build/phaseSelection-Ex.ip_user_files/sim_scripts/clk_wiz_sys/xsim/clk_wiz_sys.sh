...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_sys mylib.clk_wiz_sys mylib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_sys.wdb xsim.dir libdpi.so)
