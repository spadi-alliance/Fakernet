...
#
# Script generated by Vivado on Fri Mar 29 17:17:37 JST 2024
...
#
# Usage        : clk_wiz_sys.sh
#                clk_wiz_sys.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_sys.sh [-reset_run]
#                clk_wiz_sys.sh [-reset_log]
#                clk_wiz_sys.sh [-help]
#
...
#                script (type 'clk_wiz_sys.sh -help' for more information).
#
...
# script info
echo -e "clk_wiz_sys.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_sys.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../amaneq-skeleton.gen/sources_1/ip/clk_wiz_sys" \
  ...
  xmvlog -work mylib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic" +incdir+"../../../../../../../amaneq-skeleton.gen/sources_1/ip/clk_wiz_sys" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab mylib.clk_wiz_sys mylib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts mylib.clk_wiz_sys -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_wiz_sys_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clk_wiz_sys.sh [-step]\n\
Usage: clk_wiz_sys.sh [-lib_map_path]\n\
Usage: clk_wiz_sys.sh [-reset_run]\n\
Usage: clk_wiz_sys.sh [-reset_log]\n\
Usage: clk_wiz_sys.sh [-keep_index]\n\
